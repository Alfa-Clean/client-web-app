...
type View = 'hub' | 'cleaning' | 'chistomaty' | 'menu'
  ...
  if (view === 'menu') {
    return (
      <div class="min-h-screen bg-white flex flex-col">
        <div class="px-5 pt-12 pb-5 flex items-center gap-4">
          <button
            type="button"
            onClick={() => setView('hub')}
        ...
        <div class="flex-1 flex flex-col items-center justify-center gap-3 text-gray-400 text-sm">
  ...
  return (
    <div class="min-h-screen bg-white flex flex-col">
      ...
      {activeOrder && activeOrder !== 'loading' && (
        <ActiveOrderBanner
          order={activeOrder}
          onClick={() => {/* открыть детали заказа позже */}}
        />
      )}
